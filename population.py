...
for state in states["features"]:
    ...
    print("Estimating state population")
    ...
    for iso_geom, time in zip(iso_geoms, times):
        ...
        print(f"Estimated {near_hospitals} residents within {time} mins of a hospital.")
